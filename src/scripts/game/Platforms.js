...
export class Platforms
{
    ...
    createPlatform(data)
    {
        const platform = new Platform(data.rows, data.cols, data.x, this.dx);
    ...
    update() 
    {
        ...
        this.dx = this.isCollided ? this.dx + App.config.platforms.accelaration : this.dx - App.config.platforms.deccelaration;

        this.platforms.forEach(platform => platform.move(this.dx));
    }
